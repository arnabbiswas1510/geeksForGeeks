"""
https://practice.geeksforgeeks.org/batch/dsa-4/track/DSASP-Arrays/problem/frequency-of-array-elements-1587115620

Easy in O(N). How to do in less than O(N)?
New twist on binary search
"""
...
def findFrequencyUtil(arr, low, high, freq):
    ...
    if (arr[low] == arr[high]):
        ...
        #So this works only if input Array is sorted - wrong results otherwise
